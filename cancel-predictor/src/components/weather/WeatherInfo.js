...
import { faThermometerHalf, faWind, faCloud, faBinoculars, faCloudRain } from '@fortawesome/free-solid-svg-icons'
...
const getWeatherNow = weatherData => {
    ...
    return {
        ...
        rainInLastHour: current.rain['1h'], //rain might not always appear? 
...
export function WeatherInfo({weatherData}) {
    ...
    return <div>
        ...
        <WeatherPane>
            ...
            <div className="weatherFeature" >
                <FontAwesomeIcon className="icon" icon={faCloudRain} />
                <div>
                    {weatherNow.rainInLastHour}mm
                </div>
            </div>
            <div className="weatherFeature" >
